defmodule ErrjordanWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ErrjordanWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ErrjordanWeb.Gettext, "errors", msg, opts)
    end
  end
